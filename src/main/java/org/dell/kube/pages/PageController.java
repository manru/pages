...
public class PageController {
    ...
    public ResponseEntity<Page> create(@RequestBody Page page) {
        logger.info("READ-INFO:Fetching page  = " + page);
        logger.debug("READ-DEBUG:Fetching page  = " + page);
    ...
    public ResponseEntity<List<Page>> list() {
        logger.info("READ-INFO:Fetching all ");
        logger.debug("READ-DEBUG:Fetching all ");
